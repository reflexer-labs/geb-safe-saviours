...
contract NativeUnderlyingUniswapV3SafeSaviour is SafeMath, SafeSaviourLike {
    ...
    **/
    ...
    constructor(
        ...
        require(lpToken_ != address(0), "NativeUnderlyingUniswapV3SafeSaviour/null-lp-token");
    ...
    */
    function getReserves(uint256 safeID, address dst) external controlsSAFE(msg.sender, safeID) nonReentrant {
        ...
        require(either(systemCoins > 0, collateralCoins > 0), "NativeUnderlyingUniswapV3SafeSaviour/no-reserves");
    ...
    */
    function deposit(uint256 safeID, uint256 lpTokenAmount) external isAllowed() liquidationEngineApproved(address(this)) nonReentrant {
        require(lpTokenAmount > 0, "NativeUnderlyingUniswapV3SafeSaviour/null-lp-amount");
        ...
        require(lpToken.transferFrom(msg.sender, address(this), lpTokenAmount), "NativeUnderlyingUniswapV3SafeSaviour/could-not-transfer-lp");
    ...
    */
    function withdraw(uint256 safeID, uint256 lpTokenAmount, address dst) external controlsSAFE(msg.sender, safeID) nonReentrant {
        ...
        address safeHandler = safeManager.safes(safeID);
        require(lpTokenCover[safeHandler] >= lpTokenAmount, "NativeUnderlyingUniswapV3SafeSaviour/not-enough-to-withdraw");
    ...
    */
    function saveSAFE(address keeper, bytes32 collateralType, address safeHandler) override external returns (bool, uint256, uint256) {
        ...
        require(lpTokenCover[safeHandler] > 0, "NativeUnderlyingUniswapV3SafeSaviour/null-cover");
