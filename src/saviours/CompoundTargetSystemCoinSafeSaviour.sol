...
contract CompoundTargetSystemCoinSafeSaviour is SafeMath, SafeSaviourLike {
    // --- Auth ---
    ...
    **/
    modifier isAuthorized {
        require(authorizedAccounts[msg.sender] == 1, "CompoundTargetSystemCoinSafeSaviour/account-not-authorized");
        _;
    }
    ...
    **/
    modifier isAllowed {
        require(
          ...
          "CompoundTargetSystemCoinSafeSaviour/account-not-allowed"
        );
        _;
    }
    ...
    constructor(
      ...
      uint256 minKeeperPayoutValue_
        ...
        require(coinJoin_ != address(0), "CompoundTargetSystemCoinSafeSaviour/null-coin-join");
        require(cRatioSetter_ != address(0), "CompoundTargetSystemCoinSafeSaviour/null-cratio-setter");
        require(systemCoinOrcl_ != address(0), "CompoundTargetSystemCoinSafeSaviour/null-system-coin-oracle");
        require(oracleRelayer_ != address(0), "CompoundTargetSystemCoinSafeSaviour/null-oracle-relayer");
        require(taxCollector_ != address(0), "CompoundTargetSystemCoinSafeSaviour/null-tax-collector");
        require(liquidationEngine_ != address(0), "CompoundTargetSystemCoinSafeSaviour/null-liquidation-engine");
        require(safeManager_ != address(0), "CompoundTargetSystemCoinSafeSaviour/null-safe-manager");
        require(saviourRegistry_ != address(0), "CompoundTargetSystemCoinSafeSaviour/null-saviour-registry");
        require(cToken_ != address(0), "CompoundTargetSystemCoinSafeSaviour/null-c-token");
        require(keeperPayout_ > 0, "CompoundTargetSystemCoinSafeSaviour/invalid-keeper-payout");
        require(minKeeperPayoutValue_ > 0, "CompoundTargetSystemCoinSafeSaviour/invalid-min-payout-value");
        ...
        require(cToken.isCToken(), "CompoundTargetSystemCoinSafeSaviour/not-c-token");
        require(address(safeEngine) != address(0), "CompoundTargetSystemCoinSafeSaviour/null-safe-engine");
        require(address(systemCoin) != address(0), "CompoundTargetSystemCoinSafeSaviour/null-sys-coin");
    ...
    function modifyParameters(bytes32 parameter, uint256 val) external isAuthorized {
        if (parameter == "keeperPayout") {
            require(val > 0, "CompoundTargetSystemCoinSafeSaviour/null-payout");
            keeperPayout = val;
        }
        else if (parameter == "minKeeperPayoutValue") {
            require(val > 0, "CompoundTargetSystemCoinSafeSaviour/null-min-payout");
            minKeeperPayoutValue = val;
        }
        else if (parameter == "restrictUsage") {
            require(val <= 1, "CompoundTargetSystemCoinSafeSaviour/invalid-restriction");
            restrictUsage = val;
        }
        else revert("CompoundTargetSystemCoinSafeSaviour/modify-unrecognized-param");
    ...
    function modifyParameters(bytes32 parameter, address data) external isAuthorized {
        require(data != address(0), "CompoundTargetSystemCoinSafeSaviour/null-data");
    ...
    */
    function deposit(bytes32 collateralType, uint256 safeID, uint256 systemCoinAmount)
      external isAllowed() liquidationEngineApproved(address(this)) nonReentrant {
        ...
        require(systemCoinAmount > 0, "CompoundTargetSystemCoinSafeSaviour/null-system-coin-amount");
        require(defaultCRatio > 0, "CompoundTargetSystemCoinSafeSaviour/collateral-not-set");

        // Check that the SAFE exists inside GebSafeManager
        address safeHandler = safeManager.safes(safeID);
        require(safeHandler != address(0), "CompoundTargetSystemCoinSafeSaviour/null-handler");

        // Check that the SAFE has debt
        (, uint256 safeDebt) = safeEngine.safes(collateralType, safeHandler);
        require(safeDebt > 0, "CompoundTargetSystemCoinSafeSaviour/safe-does-not-have-debt");
        ...
        require(cToken.mint(systemCoinAmount) == 0, "CompoundTargetSystemCoinSafeSaviour/cannot-mint-ctoken");
    ...
    */
    function withdraw(bytes32 collateralType, uint256 safeID, uint256 cTokenAmount, address dst)
      external controlsSAFE(msg.sender, safeID) nonReentrant {
        require(cTokenAmount > 0, "CompoundTargetSystemCoinSafeSaviour/null-cToken-amount");

        // Fetch the handler from the SAFE manager
        address safeHandler = safeManager.safes(safeID);
        require(cTokenCover[collateralType][safeHandler] >= cTokenAmount, "CompoundTargetSystemCoinSafeSaviour/not-enough-to-redeem");
        ...
        require(cToken.redeem(cTokenAmount) == 0, "CompoundTargetSystemCoinSafeSaviour/cannot-redeem-ctoken");
    ...
    */
    function saveSAFE(address keeper, bytes32 collateralType, address safeHandler) override external returns (bool, uint256, uint256) {
        require(address(liquidationEngine) == msg.sender, "CompoundTargetSystemCoinSafeSaviour/caller-not-liquidation-engine");
        require(keeper != address(0), "CompoundTargetSystemCoinSafeSaviour/null-keeper-address");
        ...
        require(keeperPayoutExceedsMinValue(), "CompoundTargetSystemCoinSafeSaviour/small-keeper-payout-value");
        ...
        require(both(tokenAmountUsed != MAX_UINT, tokenAmountUsed != 0), "CompoundTargetSystemCoinSafeSaviour/invalid-tokens-used-to-save");
        ...
        require(cTokenCover[collateralType][safeHandler] >= add(keeperCTokenPayout, tokenAmountUsed), "CompoundTargetSystemCoinSafeSaviour/not-enough-cover-deposited");
        ...
        uint256 currentSystemCoinAmount = systemCoin.balanceOf(address(this));
        require(cToken.redeem(add(keeperCTokenPayout, tokenAmountUsed)) == 0, "CompoundTargetSystemCoinSafeSaviour/cannot-redeem-ctoken");
