    ...
    SelfPermit
{
    ...
    function tokenURI(uint256 tokenId) public view override(AlwaysApprovedERC721, IERC721Metadata) returns (string memory) {
    ...
    function _approve(address to, uint256 tokenId) internal override(AlwaysApprovedERC721) {
